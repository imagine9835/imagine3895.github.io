...
const services = [
  {
    ...
    price: "$350",
    duration: "1.5 hrs",
    includes: ["20 edited images", "1 location", "Online gallery", "Print release"],
  },
  {
    name: "Editorial / Brand",
    price: "$1,200",
    duration: "Half day",
    includes: ["60+ edited images", "Mood board & direction", "Multiple looks", "Commercial license"],
  },
  {
    name: "Events / Weddings",
    price: "From $2,500",
    duration: "6–10 hrs",
    includes: ["400+ edited images", "Two photographers", "Cinematic film reel", "Heirloom album add-on"],
  },
];
    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-12 py-24 sm:py-32">
      <div className="grid lg:grid-cols-12 gap-8 mb-16">
        ...
        <p className="lg:col-span-6 lg:col-start-7 text-[#a1a1aa] text-base sm:text-lg leading-relaxed">
          Three starting points — all sessions are tailored after a short call.
          Travel beyond the city is quoted separately. Bespoke commissions are
          always welcome.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-px bg-white/5">
        {services.map((s, i) => (
          <div
            ...
            className="bg-[#0a0a0c] p-10 border-l border-white/5 first:border-l-0 md:border-l first:md:border-l-0"
          >
            <div className="text-[10px] uppercase tracking-[0.3em] text-[#a1a1aa]">
              0{i + 1}
            </div>
            <h3 className="font-serif text-3xl mt-4">{s.name}</h3>
